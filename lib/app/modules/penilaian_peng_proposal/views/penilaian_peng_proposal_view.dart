...
class PenilaianPengProposalView
    extends GetView<PenilaianPengProposalController> {
  const PenilaianPengProposalView({Key? key}) : super(key: key);
  @override
                  ...
                  children: [
                    Obx(
                      () =>
                        ...
                        onChanged: (val) {
                          if (val == 0) {
                            controller.indexFormNilaiPengSempro.value = 0;
                          }
                          controller.selectedChips.value = val;
                        },
                        choiceItems: C2Choice.listFrom<int, String>(
                          source: controller.listPenilaianPengSempro,
                          value: (i, v) => i,
                          label: (i, v) => v,
                        ),
...
class SaranPerbaikanSemproView extends StatelessWidget {
  const SaranPerbaikanSemproView({
    super.key,
  });
