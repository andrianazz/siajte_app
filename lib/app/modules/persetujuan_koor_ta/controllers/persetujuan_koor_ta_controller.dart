...
import 'package:siajte_app/app/widgets/koor_ta/card_ba_skripsi_koor.dart';

class PersetujuanKoorTaController extends GetxController {
  ...
  Widget viewListPenilaianPengProposal() {
    switch (selectedChips.value) {
      case 0:
        return const CardBASkripsiKoor();
