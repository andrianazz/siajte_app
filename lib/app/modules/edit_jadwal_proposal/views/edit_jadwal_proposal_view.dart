...
class EditJadwalProposalView extends GetView<EditJadwalProposalController> {
  const EditJadwalProposalView({Key? key}) : super(key: key);
  @override
          ...
          Form(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.h),
                TextFormField(
                  controller: controller.judulProposal,
                  validator: (value) {
                    if (value!.isEmpty) {
                  ...
                  () => SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: controller.isLoading.isFalse
                          ? () async {
                              await controller.editJadwalSemproAPI();
                            }
                          : null,
